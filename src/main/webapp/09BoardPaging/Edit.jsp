...
//session영역에 저장된 회원 아이디를 가져와서 문자열로 변환한다.
...
<body>
	...
	<!--
	수정페이지는 일반적으로 쓰기페이지를 복사해서 제작하게 되므로 action속성값을 반드시 수정해야한다.
	만약 수정하지 않으면 게시물이 추가되는 헤프닝이 생기게 된다.
	-->
	<form name="writeFrm" method="post" action="EditProcess.jsp" onsubmit="return validateForm(this);">
		<!--
		게시물의 일련번호를 서버로 전송하기 위해 hidden타입의 <input> 태그가 반드시 필요하다.
		...
		<table border="1" width="90%">
			<tr>
				<td>제목</td>
				<td>
					<!-- <input> 태그인 경우 기존의 내용을 value 속성에 추가하면 된다. -->
