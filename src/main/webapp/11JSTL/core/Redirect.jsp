...
<body>
	...
	<!-- 
	response 내장객체를 통한 이동시에는 컨텍스트루트 경로를 반드시 기술해야한다.
	또한 파라미터가 한글인 경우 깨짐 현상이 발생되므로 URLEncoder 클래스를 통해 인코딩 처리를 해줘야한다.
	-->
	<h4>JSP 내장객체를 통한 페이지 이동</h4>
	<%--
	String p1 = URLEncoder.encode("더조은");
	String p2 = URLEncoder.encode("종각지검");
