...
<body>
    ...
    <!-- Tomcat8부터는 EL에서 변수 할당을 할 수 있다.
    하지만 변수 할당과 동시에 출력되므로 할당문 뒤에 ;''을 붙여줘야 출력되지 않는다.
    즉, EL에서 변수할당은 거의 사용되지않는다.
    -->
    ...
    <!-- 숫자와 문자열 혹은 문자열과 문자열의 경우에는 연산이 불가능하므로 예외가 발생한다. -->
    num2 + "이십" : \${num2 + "이십" }  <br /> 
    "삼십" + "사십" : \${"삼십" + "사십" } 
	...
	EL에서는 Java에서 사용하던 기본적인 비교연산자와 문자형태의 연산자 두가지 모두 사용할 수 있다.
    -->
