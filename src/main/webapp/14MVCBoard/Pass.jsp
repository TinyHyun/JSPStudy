...
<body>
	...
	<!--
	패스워드 검증 페이지는 글쓰기 페이지를 복사해서 제작하면 된다.
	단, 패스워드만 전송하면 되믈 ㅗenctype은 삭제해야한다.
	-->
	<form name="writeFrm" method="post"
	      action="../mvcboard/pass.do" onsubmit="return validateForm(this);">
	    
	    <!-- 패스워드 검증을 위해 게시물의 일련번호와 mode를 전송해야 하므로 hidden박스로 값을 저장한다. -->
		...
		<table border="1" width="90%">
		    ...
		    <tr>
		        <td colspan="2" align="center">
		            <button type="submit">검증 하기</button>
