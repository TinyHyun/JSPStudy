...
public class UploadProcess extends HttpServlet {
	...
	*/
	...
	private void insertMyFile(HttpServletRequest req, String oFileNmae, String sFileNmae) {
		...
		//DTO객체에 폼값과 파일명(원본 파일명, 저장된 파일명)을 저장한다.
		MyFileDTO dto = new MyFileDTO();
		dto.setTitle(title);
		dto.setCate(cateBuf.toString());
		dto.setOfile(oFileNmae);
		dto.setSfile(sFileNmae);
