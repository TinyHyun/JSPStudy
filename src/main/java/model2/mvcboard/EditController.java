...
//수정 페이지에서도 파일을 등록할 수 있으므로 멀티파트 설정
@MultipartConfig(
...
public class EditController extends HttpServlet {
	...
	/*
	수정 페이지지로 진입하면 기존의 내용을 가져와서 쓰기 폼에 세팅한다.
	...
	*/
	...
	/*
	수절할 내용을 입력한 후 전송된 폼값을 update 쿼리문으로 갱신한다.
	...
	*/
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		*/
		...
		영역에 저장시 Object 타입으로 자동 형변환되므로 기존의 타입으로 다운캐스팅 해야한다.
		*/
