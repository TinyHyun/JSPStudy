...
//내용보기의 매핑은 web.xml이 아닌 어노테니션을 통해 설정한다.
...
public class ViewController extends HttpServlet {
	...
	/*
	서블릿의 수명주기 메서드 중 전송 방식에 상관없이 요청을 처리하고 싶을 때 service() 메서드를 오버라이딩한다.
	해당 메서드의 역할은 요청을 분석한 후 doGet() 혹은 doPost()를 호출하는 것 이다.
	*/
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse reps) 
		...
		*/
		...
		req.getRequestDispatcher("/14MVCBoard/View.jsp").forward(req, reps);
	}
}
